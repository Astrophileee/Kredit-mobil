    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                @endif
                <form action="{{ route('mobil.update',$cars->kode_mobil ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="card">
                        <div class="card-body">
                          <div class="form-group">
                            <label for="title">kode Mobil:  {{ $cars->kode_mobil }}</label>
                            <input type="hidden" class="form-control" id="kode_mobil" name="kode_mobil"
                                placeholder="kode Mobil" value="{{ old('kode_mobil') ?? $cars->kode_mobil }}">       
                        </div>
                            <div class="form-group">
                              <label for="title">Nama Mobil</label>
                              <input type="text" class="form-control" id="nama" name="nama"
                                  placeholder="Nama Mobil" value="{{ old('nama') ?? $cars->nama }}">
                          </div>
                            <div class="form-group">
                                <label for="title">Merk</label>
                                <input type="text" class="form-control" id="merk" name="merk"
                                    placeholder="Merk Mobil" value="{{ old('merk') ?? $cars->merk }}">
                            </div>
                            <div class="form-group">
                              <label for="slug">Type</label>
                              <input type="text" class="form-control" id="type" name="type"
                                  placeholder="Type Mobil" value="{{ old('type') ?? $cars->type }}">
                          </div>
                            <div class="form-group">
                              <label for="title">Warna</label>
                              <input type="color" style="height: 100px; width:100px;" class="form-control" id="warna" name="warna"
                                  placeholder="Warna Mobil" value="{{ old('warna') ?? $cars->warna }}">
                          </div>
                            <div class="form-group">
                              <label for="title">Harga</label>
                              <input type="number" class="form-control" id="harga_mobil" name="harga_mobil"
                                  placeholder="Harga Mobil" value="{{ old('harga_mobil') ?? $cars->harga_mobil }}">
                          </div>
                            <div class="form-group">
                                <label for="image">Gambar Cover</label>
                                <input type="file" class="form-control-file" id="image" name="image" value="{{ old('image') ?? $cars->image }}">
                            </div>
