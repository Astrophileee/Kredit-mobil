...
<div class="wrapper">
                                ...
                                <table id="post-table" class="table table-bordered table-hover">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ $buyer->telpon_pembeli }}
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $buyer->ktp_pembeli }}">
                                                    Edit
                                                 </button>

                                                 <div class="modal fade" id="exampleModal{{ $buyer->ktp_pembeli }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                      <div class="modal-content">
                                                        <form action="{{ route('pembeli2.update',$buyer->ktp_pembeli) }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="modal-header">
                                                              ...
                                                              <div class="modal-body text-start">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="title">Ktp Pembeli {{ $buyer->ktp_pembeli }}</label>
                                                                    <input type="hidden" class="form-control" id="ktp_pembeli" name="ktp_pembeli"
                                                                        placeholder="No ktp" value="{{ old('ktp_pembeli') ?? $buyer->ktp_pembeli }}">
                                                                </div>
                                                                    <div class="form-group">
                                                                        <label for="title">Nama</label>
                                                                        <input type="text" class="form-control" id="nama_pembeli" name="nama_pembeli"
                                                                            placeholder="Nama" value="{{ old('nama_pembeli') ?? $buyer->nama_pembeli }}">
                                                                    </div>
                                                                    <div class="form-group">
                                                                      <label for="slug">Alamat</label>
                                                                      <input type="text" class="form-control" id="alamat_pembeli" name="alamat_pembeli"
                                                                          placeholder="Alamat" value="{{ old('alamat_pembeli') ?? $buyer->alamat_pembeli }}">
                                                                  </div>
                                                                    <div class="form-group">
                                                                      <label for="number">Telpon Pembeli</label>
                                                                      <input type="text" class="form-control" id="telpon_pembeli" name="telpon_pembeli"
                                                                          placeholder="Warna Mobil" value="{{ old('telpon_pembeli') ?? $buyer->telpon_pembeli }}">
                                                                  </div>
                                                ...
                                                <form action="{{ route('pembeli2.destroy', $buyer->ktp_pembeli) }}" class="d-inline" method="POST"
                                                    onsubmit="
                                                        return confirm('Hapus Data Pembeli?');
                                                    ">
                                                    @csrf
                                                    @method('delete')
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="{{ route('pembeli2.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-header">
                <h5 class="modal-title" id="createTugasModalLabel">Pembeli</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
