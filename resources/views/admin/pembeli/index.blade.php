            ...
            <div class="col">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="/admin/pembeli/create" class="btn btn-primary ml-auto card-tools"><i class="fas fa-plus mr-2"></i><span>Buat Postingan</span></a>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="post-table" class="table table-bordered table-hover">
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <a href="{{ route('pembeli.edit', $buyer->ktp_pembeli) }}" class="btn btn-primary btn-sm m-1"><i class="fas fa-edit mr-2"></i><span>Edit</span></a>
                                            <form action="{{ route('pembeli.destroy', $buyer->ktp_pembeli) }}" class="d-inline" method="POST"
                                                onsubmit="
