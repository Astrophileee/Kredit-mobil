    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                @endif
                <form action="{{ route('pembeli.update',$buyers->ktp_pembeli ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="card">
                        <div class="card-body">
                          <div class="form-group">
                            <label for="title">Ktp Pembeli {{ $buyers->ktp_pembeli }}</label>
                            <input type="hidden" class="form-control" id="ktp_pembeli" name="ktp_pembeli"
                                placeholder="No ktp" value="{{ old('ktp_pembeli') ?? $buyers->ktp_pembeli }}">
                        </div>
                            <div class="form-group">
                                <label for="title">Nama</label>
                                <input type="text" class="form-control" id="nama_pembeli" name="nama_pembeli"
                                    placeholder="Nama" value="{{ old('nama_pembeli') ?? $buyers->nama_pembeli }}">
                            </div>
                            <div class="form-group">
                              <label for="slug">Alamat</label>
                              <input type="text" class="form-control" id="alamat_pembeli" name="alamat_pembeli"
                                  placeholder="Alamat" value="{{ old('alamat_pembeli') ?? $buyers->alamat_pembeli }}">
                          </div>
                            <div class="form-group">
                              <label for="number">Telpon Pembeli</label>
                              <input type="text" class="form-control" id="telpon_pembeli" name="telpon_pembeli"
                                  placeholder="Warna Mobil" value="{{ old('telpon_pembeli') ?? $buyers->telpon_pembeli }}">
                          </div>
